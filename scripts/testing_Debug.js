...
function sceneName() {
  let sceneName;
  if (sceneNum == 0) {
    sceneName = "Title/ Born";
  } else if (sceneNum == 1) {
    sceneName = "Tutorial/ Starting";
  } else if (sceneNum == 2) {
    sceneName = "Childhood Room";
  } else if (sceneNum == 3) {
    sceneName = "Childhood Temple";
  } else if (sceneNum == 4) {
    sceneName = "Teenage Room";
  } else if (sceneNum == 5) {
    sceneName = "High School Art Class Room";
  } else if (sceneNum == 6) {
    sceneName = "College Dorm Entrence";
  } else if (sceneNum == 7) {
    sceneName = "College Dorm Room";
  } else if (sceneNum == 8) {
    sceneName = "Gallary";
  } else if (sceneNum == 9) {
    sceneName = "All Location Map";
  }
...
function sceneText_Debug() {
  ...
  rect(15, 10, 510, 130, 5);

  textAlign(LEFT);
  textSize(15);
  fill(50, 50, 50, 200);
  text(
    `sceneNum [ ${sceneNum} ] [ ${sceneName()} ] locationName [ ${locationName[sceneNum]
    } ]`,
    20,
    30
  );
  ...
  text(
    `chara.checkStage() [ ${chara.checkStage()} ] (0-1, 2-3, 4-5, 6, 7)`,
    20,
    110
  );
...
function allDebugFunction() {
  ...
  // itemTextBox("suitcase", "testing SLDJFLSDJ;FLKAJ ")
